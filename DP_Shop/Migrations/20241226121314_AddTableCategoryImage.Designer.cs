...
namespace DP_Shop.Migrations
{
    ...
    [Migration("20241226121314_AddTableCategoryImage")]
    partial class AddTableCategoryImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DP_Shop.Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3389),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3392),
            ...
            modelBuilder.Entity("DP_Shop.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3623),
                            ...
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3625),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3636),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3637),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3639),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3640),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3643),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3643),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3646),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3646),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3650),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3651),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3653),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3654),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 12, 26, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3656),
                            Description = "Bánh ép Huế là một đặc sản khởi nguồn từ biển Thuận An, Huế. Bánh ép Huế là sản phẩm được chế biến theo công thức đặc biệt riêng, nhất là khi kết hợp hài hòa giữa thịt mỡ cùng với hương thơm của sả, hành, ớt, tạo nên vị ngon khó cưỡng, không thể tách rời. Bên cạnh đó, bánh có thể ăn kèm với tương ớt cay cay thì quá là ngon miệng. Bánh không chất bảo quản, không màu thực phẩm và được đóng gói trong hộp giấy đảm bảo chất lượng sản phẩm an toàn, khi được chứng nhận và cung cấp chứng chỉ an toàn vệ sinh thực phẩm HACCP.",
                            ExpiryDate = new DateTime(2025, 1, 25, 19, 13, 11, 300, DateTimeKind.Local).AddTicks(3657),
